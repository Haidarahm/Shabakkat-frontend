...
export default function IndustryCard({ industry }: { industry: Industry }) {
  return (
    <div id={industry.slug} className={`scroll-mt-[132px] h-full rounded border-t-[3px] border border-border bg-white p-7 lg:scroll-mt-[160px] ${accentBorder[industry.color]}`}>
