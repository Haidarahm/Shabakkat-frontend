...
/** Journey Timeline — selected engagements from the content doc. */
export const timeline: TimelineEntry[] = [
  ...
  {
    slug: "stc-mobily-ksa-rollout",
    year: "2005",
    engagement: "STC Mobily KSA",
    service: "Rollout, Managed Services & Vendor Management",
    status: "Completed",
    color: "cyan",
    side: "right",
